...
[![GoDoc](http://godoc.org/github.com/W1llyu/go-engine.io?status.svg)](http://godoc.org/github.com/W1llyu/go-engine.io) [![Build Status](https://travis-ci.org/W1llyu/go-engine.io.svg)](https://travis-ci.org/W1llyu/go-engine.io)
...
```bash
go get github.com/W1llyu/go-engine.io
```

Import it with:

```go
import "github.com/W1llyu/go-engine.io"
```
